...
// initIMU, turnsensorReset and TurnsensorUpdate Adapted frome https://github.com/pololu/zumo-32u4-arduino-library/blob/master/examples/RotationResist/RotationResist.ino?fbclid=IwAR1aDGVLlDDXStga1n5_6nCaFsC6w3WE46MjwiJTdZWmy1ffSbeNHRwjPKU 
void initIMU() {
  imu.init(); 
  imu.enableDefault();
...
// this function is adapted forme example code frome the Pololu Zumo32U4
